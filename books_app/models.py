...
class Book(db.Model):
    ...
    users = db.relationship(
        "User", secondary="favorite_books", back_populates="favorite_books"
    )
    ...
    def __repr__(self):
        return f"<Book: {self.title, self.publish_date, self.author, self.audience, self.genres}>"
...
class User(db.Model):
    ...
    favorite_books = db.relationship(
        "Book", secondary="favorite_books", back_populates="users"
    )


user_favorite_books_table = db.Table(
    "favorite_books",
